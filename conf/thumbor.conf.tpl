...
S3_STORAGE_SSE = {{ S3_STORAGE_SSE | default(False)}}

# put data into S3 with Reduced Redundancy
# https://aws.amazon.com/about-aws/whats-new/2010/05/19/announcing-amazon-s3-reduced-redundancy-storage/
S3_STORAGE_RRS = {{ S3_STORAGE_RRS | default(False)}}

# Use Role-based connection
# http://docs.aws.amazon.com/IAM/latest/UserGuide/roles-assume-role.html
AWS_ROLE_BASED_CONNECTION = {{ S3_STORAGE_RRS | default(True)}}
...
AWS_ENABLE_HTTP_LOADER = {{ S3_STORAGE_RRS | default(False)}}
